        ...
        <div class="card-body">
            <div class="px-2">
                ...
                <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="image" class="form-label">Rasmni yuklang [majburiy emas, agar yangi rasmmni yuklmasangiz oldingisini o'chirish uchun maydonni bo'sh qoldiring]</label>
