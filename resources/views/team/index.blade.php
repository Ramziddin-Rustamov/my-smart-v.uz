        ...
        <div class="container">
            <div class="row  justify-content-around">
                <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
                    ...
                    <p class="text-secondary mb-5 text-center lead fs-4">Bizning Mangitobod Mahallamizda ishlab kelayotgan
                        ishchi jamoamiz bilan tanishing !</p>
                            ...
                            <div class="card border-0 border-bottom border-primary shadow-sm overflow-hidden">
                                <div class="card-body p-0">
                                    <figure class="m-0 p-0">
                                        <img class="img-fluid" loading="lazy" src="{{ asset($user->image) }}"
                                            alt="Flora Nyra">
                                        <figcaption class="m-0 p-4">
                                            <h4 class="mb-1 text-info">
                                                {{ $user->first_name . ' ' . $user->last_name . ' ' . $user->father_name }}
                                            </h4>
                                            <p class="text-secondary mb-0">
                                                {{ $user->profiles->job ?? ' Hozircha kasbi kiritilmagan' }}</p>
                                            <div class="row">
