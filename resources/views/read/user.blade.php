                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="flex-shrink-0">
                                                <a href="{{ asset($user->image) }}">
                                                    <img src="{{ asset($user->image) }}" alt="Generic placeholder image"
                                                        class="img-fluid" style="width: 100%; border-radius: 10px;">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-12 py-2">
                                            ...
                                            <p class="mb-2 pb-1" style="color: #2b2a2a;">
                                                {{ $user->profiles->job ?? 'Kasbi yo`q' }}</p>
                                        </div>
                                        <div class="col-12">
                                            @if ($user->instagram)
                                                <a href="https://instagram.com/{{ $user->profiles->instagram }}"
                                                    class="btn btn-info me-1 mb-2 flex-grow-1"><i
                                        ...
                                        <div class="col-12">
                                            <div class="d-flex">
                                                <a href="tel:{{ $user->profiles->phone }}"
                                                    class="btn btn-primary me-1 flex-grow-1">Telefon qilish</a>
                                                <a href="https://t.me/{{ $user->profiles->telegram }}"
                                                    class="btn btn-info me-1 flex-grow-1">Telegram</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
