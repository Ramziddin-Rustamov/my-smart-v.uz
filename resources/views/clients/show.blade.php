            ...
            <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="col col-lg-12 col-xl-12">
                    <div class="justify-content-between d-flex">
                        ...
                        <h6 class="text-success">{{ __('Client ') }}</h6>
                        <hr>
                    </div>
                    <div class="card">
                        <div class="rounded-top text-white d-flex flex-row" style="background-color: #000; height:200px;">
                            <div class="ms-4 mt-5 d-flex flex-column" style="width: 150px;">
                                <img class="img-fluid img-thumbnail mt-4 mb-2" style="width: 150px; z-index: 1"
                                    src="{{ asset($user->image) }}" alt="{{ $user->name }}`image">
                                <button desabled type="button" class="btn btn-dark" data-mdb-ripple-color="dark"
                                    style="z-index: 1;">
                                    {{ $user->job ?? 'User JOB' }}
                                </button>
                            </div>
