  ...
  <div class="row justify-content-center">
      ...
      <div class="col-md-8">
        <div class="text-start border-bottom mb-3">
          <a href="{{ route('posts.index') }}" class="btn btn-danger mb-1">Orqaga  </a>
        </div>
        <form method="post" action="{{ route('posts.update',$post->id) }}" class="row g-3 needs-validation" novalidate>
          ...
          <div class="row">
            <div class="col-md-12">
                ...
                <input type="text" class="form-control @error('title') is-invalid @enderror" id="validationCustom01" name="title" value="{{ old('title') ?? $post->title}}" required>
              ...
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <textarea class="form-control @error('body') is-invalid @enderror" id="validationTextarea" name="body" rows="6" cols="4" placeholder="Matn qismi" required>{{ old('body') ?? $post->body }}</textarea>
