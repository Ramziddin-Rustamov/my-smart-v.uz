    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('info_villages.update', $infoVillage->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <img class=" img-fluid " src="{{$infoVillage->image}}" alt="" srcset="">
                        ...
                        <button type="submit" class="btn btn-primary">Update Info Village</button>
                    </form>
                </div>
            </div>
        </div>
