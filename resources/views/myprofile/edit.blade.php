        ...
        <div class="col-xl-4">
            ...
            <div class="card mb-4 mb-xl-0">
                ...
                <div class="card-body text-center">
                    ...
                    <img class="img-account-profile rounded-circle mb-2" style="width:190px;" src="{{ asset($user->image) }}" alt="{{ $user->first_name}}`image">

                    <!-- Profile picture help block-->
                    <div class="small font-italic text-muted mb-4">{{ __('Rasm 5 mg dan  oshmasligi kerak') }}</div>
                    <!-- Profile picture upload button-->
                    <div class="mb-3">
                        <label for="formFile" class="form-label">{{ __('Rasmingizni o`zgartirmoqchi bo`lsangiz yangi rasm tanlang  ') }}</label>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control @error('first_name') is-invalid @enderror" id="inputUsername" type="text" name="first_name" placeholder="Enter your username" value="{{ old('first_name') ?? $user->first_name  }}">
                        </div>
                        @error('first_name')
                            <div class="alert alert-danger" >
                                {{ $message }}
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control @error('last_name') is-invalid @enderror" id="inputUsername" type="text" name="last_name" placeholder="Enter your username" value="{{ old('last_name') ?? $user->last_name  }}">
                        </div>
                        @error('last_name')
                            <div class="alert alert-danger" >
                                {{ $message }}
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control @error('father_name') is-invalid @enderror" id="inputUsername" type="text" name="father_name" placeholder="Enter your username" value="{{ old('father_name') ?? $user->father_name  }}">
                        </div>
                        @error('father_name')
                            <div class="alert alert-danger" >
                                {{ $message }}
                       ...
                       @enderror
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control @error('job') is-invalid @enderror" id="Job" type="text" name="job" placeholder="Kasbingiz ?" value="{{old('job') ?? $user->profiles->job }}">
                            </div>
                            @error('job')
                            <div class="alert alert-danger" >
                                {{ $message }}
                           ...
                           @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control @error('location') is-invalid @enderror" id="location" type="text" name="location" placeholder="Manzilingiz kiriting  " value="{{old('location') ?? $user->profiles->location }}">
                            </div>
                            @error('location')
                            <div class="alert alert-danger" >
                                {{ $message }}
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control @error('about') is-invalid @enderror" id="about" name="about" placeholder="Biografiya " >{{ old('about') ?? $user->profiles->about }}</textarea>
                            </div>
                            @error('about')
                            <div class="alert alert-danger" >
                                {{ $message }}
                        ...
                        <!-- Save changes button-->
                        <button class="btn btn-primary m-sm-3 " type="submit">{{ __('O`zgarishlarni saqlang ') }}</button>
