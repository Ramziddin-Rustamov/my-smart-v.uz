                        ...
                        <div class="card-body text-center">
                            <a href="{{ asset($user->image) }}">
                                <img class="img-account-profile rounded-circle mb-2"
                                    style="width: 102px; height: 100px; object-fit: cover" src="{{ asset($user->image) }}"
                            ...
                            <div class="d-flex justify-content-center mb-2">
                                <a class="btn btn-outline-info px-2 mx-2"
                                    href="{{ route('profile.edit', ['id' => $user->id]) }}" title="Edit"><i
                                        class="fas fa-pen"></i> Tarirlash</a>
                                <a class="btn btn-outline-info" href="{{ route('profile.show', ['id' => $user->id]) }}"
                                    title="Public view"><i class="fas fa-eye"></i> Ko'rinish </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body p-0">
                            <ul class="list-group list-group-flush rounded-3">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                                    ...
                                    <p class="mb-0">{{ $user->profiles->telegram ?? 'Telegram haqida ma`lumot  yo`q' }}
                                    </p>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0">{{ $user->profiles->location ?? 'Manzilingizni kiriting' }}
                                    </p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0">
                                        {{ $user->profiles->about ?? 'O`zingiz haqingizda ma`lumot kiritmadingiz ' }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
