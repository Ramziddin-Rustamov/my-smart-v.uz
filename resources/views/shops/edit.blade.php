...
<div class="container">
    ...
    <form action="{{ route('shops.update', $shop->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="opened_date" name="opened_date" value="{{ $shop->opened_date }}" required>
        </div>
        <div class="mb-3">
            <label for="user_id" class="form-label">User ID</label>
            <input type="number" class="form-control" id="user_id" name="user_id" value="{{ $shop->user_id }}" required>
        </div>
        <div class="mb-3">
