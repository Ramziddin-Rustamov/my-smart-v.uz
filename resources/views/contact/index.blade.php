            ...
            <div class="row mt-2 justify-content-center" data-aos="fade-up">
                <div class="col-lg-10">
                    <form action="{{ route('contact.store') }}" method="post" role="form" class="php-email-form ">
                        ...
                        <div class="form-group mt-3">
                            <textarea class="form-control @error('message') is-invaled @enderror" name="message" rows="3" required
                                placeholder="Enter What are you going to say" required></textarea>
                        </div>
                        @auth
                            <div class="my-3">
